...
object ImageUtils {
    ...
    private fun saveBitmap(bitmap: Bitmap, filename: String) {
        val root =
            Environment.getExternalStorageDirectory().absolutePath + File.separator.toString() + "tensorflow"
    ...
    private fun YUV2RGB(y: Int, u: Int, v: Int): Int {
        ...
        var localU = u
        var localV = v
        localY = if (localY - 16 < 0) 0 else localY - 16
        localU -= 128
        localV -= 128
        ...
        val y1192 = 1192 * localY
        var r = y1192 + 1634 * localV
        var g = y1192 - 833 * localV - 400 * localU
        var b = y1192 + 2066 * localU
